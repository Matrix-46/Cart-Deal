   ...
   <section class="add-products">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         <div class="flex">
            ...
            <!-- Updated: Use a dropdown list for the category -->
            <div class="inputBox">
         ...
         if ($select_products->rowCount() > 0) {
            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="box">
                  ...
                  <div class="flex-btn">
                     <a href="update_product.php?update=<?= htmlspecialchars($fetch_products['id']); ?>"
                        class="option-btn">Update</a>
                     <a href="products.php?delete=<?= htmlspecialchars($fetch_products['id']); ?>" class="delete-btn"
